...
Existen varias funciones que nos permiten seleccionar variables en función de sus nombres. Alguna de ellas son:
...
-  Filtramos la categoría 1 de la variable `parent.jefe` que corresponde a los jefes de hogar.
-  Agrupamos por sexo.
...
Nos gustaría tener la variable \textbf{departamento} que indica el departamento al cuál pertenece el hogar de la muestra.
